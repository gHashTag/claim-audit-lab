...
"С%d" % i: "сравниваются две формулы, выборки нет"
                      for i in (3, 5, 7, 8, 9, 10, 11, 20, 21)}, 
            "С15": "утверждение о числе в документе, внешней величины нет",
            "С16": "перебора формул в этом утверждении нет",
            "С17": "длина описания неприменима: это не закон, а запись числа",
            "С18": "объявленных границ перебора это утверждение не касается",
    ...
    Claim(
        ...
        claim_family="zeta_spacing_statistics",
        observable="gap_quantiles_p50_p95_p99",
        measurement_source="odlyzko_100k",
        uncertainty_type="finite_sample_monte_carlo",
        novelty_key="zeta:gap_quantiles:v1",
        information_class="high",
        purpose="model_discrimination",
        models=("exact_GUE", "Wigner_surmise", "Poisson"),
        independent_of={"observable": "три квантиля вместо KS/AD формы"},
        ...
        skip_reasons={
            ...
            "С6": "эталон проверяется ситом С6 во втором утверждении "
                            "этого же файла",
            "С20": "эффективное число попыток разбирается на семействе формул "
                   "целиком; для одиночного утверждения перебор не воспроизводим",
            "С21": "алгебраическая объяснимость разбирается на семействе формул "
                   "целиком; линейная форма в логарифмах не задана",
            "С19": "утверждение не о члене семейства формул; ошибка double несопоставимо меньше сравниваемой погрешности",
        },
